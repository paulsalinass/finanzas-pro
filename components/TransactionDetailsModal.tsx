                ...
                >
                    ...
                    <div className="p-8 overflow-y-auto custom-scrollbar flex-1">
                        ...
                        <div className="text-center mb-8">
                            <div className={`text-5xl font-black mb-8 ${transaction.type === 'INCOME' ? 'text-success' : 'text-gray-900 dark:text-white'}`}>
                            ...
                            <div className="flex flex-nowrap items-center justify-center gap-1 w-full">
                                {/* 1. Account */}
                                <span className="shrink-0 inline-flex items-center px-2 py-0.5 rounded-full text-[9px] font-bold uppercase tracking-wider bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 border border-slate-200 dark:border-slate-700 whitespace-nowrap">
                                    <span className="material-symbols-outlined text-[12px] mr-1">account_balance</span>
                                    {transaction.account}
                                </span>

                                {/* 2. Type */}
                                <span className={`shrink-0 inline-flex items-center px-2 py-0.5 rounded-full text-[9px] font-bold uppercase tracking-wider border whitespace-nowrap ${transaction.type === 'INCOME'
                                ...
                                {(() => {
                                    ...
                                    return (
                                        <span className={`shrink-0 inline-flex items-center px-2 py-0.5 rounded-full text-[9px] font-bold uppercase tracking-wider border whitespace-nowrap ${colors.bg} ${colors.text} ${colors.border}`}>
                                            <CategoryIcon icon={cat?.icon || 'category'} className="text-[12px] mr-1" />
                    ...
                    {/* Footer Actions */}
                    <div className="p-4 border-t border-gray-100 dark:border-white/5 bg-gray-50 dark:bg-[#252b36]/50 flex flex-row items-center justify-between gap-2">
                        <button
                            onClick={handleDelete}
                            className="flex-1 py-2.5 rounded-xl border border-gray-200 dark:border-white/10 text-danger hover:bg-danger/10 text-[11px] sm:text-xs font-bold transition-all flex items-center justify-center gap-1.5"
                        >
                        ...
                        <button
                            ...
                            className="flex-1 py-2.5 rounded-xl border border-gray-200 dark:border-white/10 text-gray-700 dark:text-gray-300 hover:bg-white dark:hover:bg-white/5 text-[11px] sm:text-xs font-bold transition-all flex items-center justify-center gap-1.5"
                        >
                        ...
                        <button
                            ...
                            className="flex-1 py-2.5 rounded-xl bg-primary hover:bg-primary-hover text-white text-[11px] sm:text-xs font-bold shadow-lg shadow-primary/20 transition-all flex items-center justify-center gap-1.5"
                        >
