...
export default function BudgetDetailsModal({ isOpen, onClose, budget, onEdit }: BudgetDetailsModalProps) {
    ...
    return (
        <div
            className={`fixed top-0 bottom-0 right-0 left-0 lg:left-[var(--sidebar-width)] z-[100] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm transition-opacity duration-300 ${isClosing ? 'animate-fade-out' : 'animate-fade-in'}`}
            onClick={handleClose}
        >
            <div
            ...
            >
                ...
                <div className="p-8 pb-0 flex items-start justify-between">
                    ...
                    <div className="flex gap-2">
                        ...
                        <button
                            ...
                            className="size-10 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-slate-500 hover:text-red-500 transition-colors"
                        >
                ...
                {showDeleteConfirm && (
                    <div className="absolute inset-0 z-10 flex items-center justify-center bg-slate-900/40 backdrop-blur-[2px] animate-fade-in">
                        <div className="w-[400px] bg-white dark:bg-[#1e293b] rounded-[2rem] p-8 shadow-2xl animate-scale-in flex flex-col items-center text-center">
