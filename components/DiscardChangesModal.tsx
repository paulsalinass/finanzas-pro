    ...
    return (
        <div className={`fixed inset-0 z-50 flex items-center justify-center p-4 transition-all duration-300 ${isClosing ? 'opacity-0' : 'opacity-100'}`}>
            ...
            <div className={`relative w-full max-w-md bg-white dark:bg-slate-800 rounded-3xl shadow-2xl overflow-hidden transform transition-all duration-300 ${isClosing ? 'scale-95 translate-y-4' : 'scale-100 translate-y-0'}`}>
                ...
                {/* Header Pattern */}
                <div className="absolute top-0 left-0 right-0 h-24 bg-gradient-to-br from-amber-500/20 to-orange-600/20 dark:from-amber-500/10 dark:to-orange-600/10" />

                <div className="relative p-6 px-8 pt-8 text-center">
                    {/* Icon */}
                    <div className="mx-auto mb-6 w-16 h-16 rounded-full bg-amber-50 dark:bg-amber-900/30 flex items-center justify-center shadow-lg shadow-amber-500/20 ring-4 ring-white dark:ring-slate-800">
                        <AlertTriangle size={32} className="text-amber-500 dark:text-amber-400" strokeWidth={2} />
                    </div>
                    ...
                    <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed mb-8">
                        Tienes cambios sin guardar. Si sales ahora, se perderán todos los datos modificados.
                    </p>
                    ...
                    <div className="flex gap-3">
                        ...
                        <button
                            ...
                            className="flex-1 px-4 py-3 rounded-xl bg-amber-500 hover:bg-amber-600 text-white font-bold text-sm shadow-lg shadow-amber-500/25 transition-all hover:-translate-y-0.5"
                        >
                            Descartar cambios
                        </button>
                    </div>
