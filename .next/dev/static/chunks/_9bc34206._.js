...
"[project]/components/CreateBudgetModal.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CreateBudgetModal({ isOpen, onClose }) {
    _s();
    const { categories, addBudget, ledgers, activeBookId } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$FinanceContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFinance"])();
    ...
    const [recurrenceOption, setRecurrenceOption] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('MONTHLY');
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CreateBudgetModal.useEffect": ()=>{
            const handleKeyDown = {
                "CreateBudgetModal.useEffect.handleKeyDown": (e)=>{
                    if (e.key === 'Escape' && isOpen) {
                        onClose();
                    }
                }
            }["CreateBudgetModal.useEffect.handleKeyDown"];
            window.addEventListener('keydown', handleKeyDown);
            return ({
                "CreateBudgetModal.useEffect": ()=>window.removeEventListener('keydown', handleKeyDown)
            })["CreateBudgetModal.useEffect"];
        }
    }["CreateBudgetModal.useEffect"], [
        isOpen,
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                            ...
                                            children: recurrenceOptions.map((opt)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                    value: opt.value,
                                                    children: opt.label
                                                }, opt.value, false, {
                                                    fileName: "[project]/components/CreateBudgetModal.tsx",
...
_s(CreateBudgetModal, "hJlEp3BUmig2T1B0b60sJKHlujc=", false, function() {
    return [
...
_c = CreateBudgetModal;
var _c;
__turbopack_context__.k.register(_c, "CreateBudgetModal");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$FinanceContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/context/FinanceContext.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$CreateBudgetModal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/CreateBudgetModal.tsx [app-client] (ecmascript)");
...
function Budgets() {
    ...
    const { budgets, categories, transactions, formatAmount } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$FinanceContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFinance"])();
    ...
    const calculatedBudgets = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Budgets.useMemo[calculatedBudgets]": ()=>{
            return budgets.map({
                "Budgets.useMemo[calculatedBudgets]": (budget)=>{
                    const budgetSpent = transactions.filter({
                        "Budgets.useMemo[calculatedBudgets].budgetSpent": (t)=>{
                            ...
                            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$isWithinInterval$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isWithinInterval"])(txDate, {
                                start: dateRange.start,
                                end: dateRange.end
                            });
                        }
                    }["Budgets.useMemo[calculatedBudgets].budgetSpent"]).reduce({
                        "Budgets.useMemo[calculatedBudgets].budgetSpent": (sum, t)=>sum + t.amount
                    }["Budgets.useMemo[calculatedBudgets].budgetSpent"], 0);
                    return {
                        ...budget,
                        spent: budgetSpent
                    };
    ...
    const totalPlanned = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Budgets.useMemo[totalPlanned]": ()=>calculatedBudgets.reduce({
    ...
    const totalSpent = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Budgets.useMemo[totalSpent]": ()=>calculatedBudgets.reduce({
    ...
    const filteredBudgets = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Budgets.useMemo[filteredBudgets]": ()=>{
            let result = calculatedBudgets.filter({
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$CreateBudgetModal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
...
//# sourceMappingURL=_9bc34206._.js.map