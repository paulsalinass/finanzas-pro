...
function Dashboard() {
    ...
    const { transactions, accounts, totalBalance, budgets, commitments, recurringRules, categories, openTransactionModal, formatAmount } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$FinanceContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFinance"])();
    ...
    const categoryVisualMap = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useMemo({
        "Dashboard.useMemo[categoryVisualMap]": ()=>{
            const map = new Map();
            categories.forEach({
                "Dashboard.useMemo[categoryVisualMap]": (cat)=>{
                    map.set(cat.id, {
                        name: cat.name,
    ...
    const getCategoryVisuals = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Dashboard.useCallback[getCategoryVisuals]": (transaction)=>{
    ...
    }["Dashboard.useCallback[getCategoryVisuals]"], [
        categoryVisualMap
    ]);
...
_s(Dashboard, "nWfTzwGDDS98uxEZ4VkOf/vqzJs=", false, function() {
    return [
...
_c1 = Dashboard;
var _c, _c1;
__turbopack_context__.k.register(_c, "HEX_ALPHA");
...
//# sourceMappingURL=_a1cf1220._.js.map